...
<p>
    <a href="<?php echo $this->app->createUrl(array('snippet', 'add')); ?>" class="btn btn-primary">Create snippet</a>
</p>
...
<?php foreach ($this->models as $model): ?>
    <div class="list-group-item">
        <div class="row">
            <div class="col-md-4"><b><a href="<?php echo $this->app->createUrl(array('snippet', 'edit', 'id'=>$model->id)); ?>"><?php echo htmlspecialchars($model->name); ?></a></b></div>
            ...
            <div class="col-md-2 text-center"><a href="<?php echo $this->app->createUrl(array('snippet', 'delete', 'id'=>$model->id)); ?>" type="button" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure?')">Delete</a></div>
        </div>
    </div>
<?php endforeach; ?>
</div>