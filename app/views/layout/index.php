...
<?php foreach ($this->models as $model): ?>
    <div class="list-group-item">
        <div class="row">
            <div class="col-md-2"><a href="<?php echo $this->app->createUrl(array('layout', 'edit', 'id'=>$model->id)); ?>"><?php echo $model->name; ?></a></div>
            <div class="col-md-2"><?php echo $model->create_date; ?></div>
            <div class="col-md-2"><?php echo $model->update_date; ?></div>
            <div class="col-md-2"><a href="<?php echo $this->app->createUrl(array('user', 'edit', 'id'=>$model->create_user_id)); ?>"><?php echo $model->createdBy->name; ?></a></div>
            <div class="col-md-2"><a href="<?php echo $this->app->createUrl(array('user', 'edit', 'id'=>$model->update_user_id)); ?>"><?php echo $model->updatedBy->name; ?></a></div>
